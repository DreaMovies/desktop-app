...
var eztv_views 		= require('../../view/eztv_view.js');

const axios_eztv = axios.create({
...
var getListReleases = function(page = 1){
...
var getListByShow = function(imdb_id, page = 1){
