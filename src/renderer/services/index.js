...
export default {
    loadPlugin(plugin){
        ...
        //const pluginsPath   = pluginsFolder;//runningPath +
//
        //const fullPluginPath = pluginsPath + plugin + ".js";
//
        //const component = require(fullPluginPath);

        //const files = require.context('./api/', false, /\.js$/);

        //files.keys().forEach(key => {
        //    if (key === './example.js' || key === './index.js') return
